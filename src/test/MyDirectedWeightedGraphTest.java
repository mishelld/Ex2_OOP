...
public class MyDirectedWeightedGraphTest {
    ...
    maincodes.DirectedWeightedGraphAlgorithmsImpl algoGraph;

    MyDirectedWeightedGraphTest() {
        graph = maincodes.Ex2.getGrapg("data/G1.json"); // enter here the path for G1 json
        algoGraph = new maincodes.DirectedWeightedGraphAlgorithmsImpl();
...
//        System.out.println(test.algoGraph.center().getKey());
    ...
    void testGetNode() {
        MyDirectedWeightedGraphTest test1 = new MyDirectedWeightedGraphTest();
        GeoLocation g = new maincodes.GeoLocationImpl(35.19589389346247,32.10152879327731,0.0);
